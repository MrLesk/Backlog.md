...
- If a convention matters for agent behavior, document it in the public MCP/instruction surface. Example: ordinal values should prefer spaced integers such as `1000`, `2000`, `3000` so later inserts have room.
