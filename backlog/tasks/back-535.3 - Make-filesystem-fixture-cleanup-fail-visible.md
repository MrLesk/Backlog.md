...
- [ ] #3 All 58 enumerated filesystem-only teardown failures are fail-visible without changing test behavior
- [ ] #4 No BACK-535.4 resource-owning site and no explicitly justified or expected-error catch site is changed
<!-- AC:END -->
...
2. Convert the 58 enumerated filesystem-only teardown sites to direct fail-visible cleanup, using framework hooks.
