...
The amend decision belongs in the shared core mutation path so CLI, TUI, browser, and MCP-triggered mutations cannot drift apart.
...
- [ ] #4 In amend-own mode the first automatic mutation after a non-owned boundary creates one new Backlog-owned commit.
...
- [ ] #6 A non-owned tip always produces a new commit and starts a new amendable sequence.
...
- [ ] #13 Tests cover both modes across task, draft, document, decision, milestone, and agent-instruction mutations, and custom backlog roots.
<!-- AC:END -->
