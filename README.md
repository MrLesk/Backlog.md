...
## 📊 Backlog.md Project Status (v1.14.4)

This board was automatically generated by [Backlog.md](https://backlog.md)

Generated on: 2025-09-30 19:40:04

| To Do | In Progress | Done |
| --- | --- | --- |
| **TASK-276** - Implement drag mode for TUI kanban board | **TASK-280** - Fix TUI task list selection and detail pane synchronization bug [@codex]<br>*#bug #tui* | **TASK-282** - Fix TUI detail pane loading state regression [@codex]<br>*#bug* |
| **TASK-270** - Prevent command substitution in task creation inputs [@codex] | └─ **TASK-24.1** - CLI: Kanban board milestone view [@codex] | **TASK-275** - Extract task reordering logic to core module [@codex] |
| **TASK-268** - Show agent instruction version status [@codex] | **TASK-273** - Refactor search [@codex]<br>*#core #search* | **TASK-262** - TUI: Show all configured status columns in Kanban [@codex]<br>*#tui #board #kanban #config #parity* |
| **TASK-267** - Add agent instruction version metadata [@codex] |  | **TASK-281** - Fix backlog init skip option [@codex]<br>*#bug* |
| **TASK-260** - Web UI: Add filtering to All Tasks view [@codex]<br>*#web-ui #filters #ui* |  | **TASK-279** - Add cleanup functionality to web UI for managing completed tasks [@claude] |
| **TASK-259** - Add task list filters for Status and Priority<br>*#tui #filters #ui* |  | **TASK-274** - Fix Kanban boards missing live updates [@claude] |
| **TASK-257** - Deep link URLs for tasks in board and list views |  | └─ **TASK-273.06** - 273.06: Web UI on centralized search [@codex]<br>*#web #search #ui* |
| **TASK-200** - Add Claude Code integration with workflow commands during init<br>*#enhancement #developer-experience* |  | └─ **TASK-273.05** - 273.05: Server endpoints on shared store/search [@codex]<br>*#server #search #infra* |
| **TASK-244** - TUI: add live updates via watch in task list and kanban [@codex]<br>*#tui #watcher #enhancement* |  | └─ **TASK-273.04** - 273.04: CLI & TUI search integration [@codex]<br>*#cli #tui #search* |
