...
// Load index.html at runtime to avoid bundler scanning script tags during CLI compile
...
export class BacklogServer {
	...
	async start(port?: number, openBrowser = true): Promise<void> {
		...
		try {
			const webIndexPath = join(process.cwd(), "src", "web", "index.html");
			this.indexHtmlCache = await Bun.file(webIndexPath).text();
			...
			this.server = Bun.serve({
				...
				routes: {
					"/": this.indexHtmlCache,
					"/tasks": this.indexHtmlCache,
					"/drafts": this.indexHtmlCache,
					"/documentation": this.indexHtmlCache,
					"/documentation/*": this.indexHtmlCache,
					"/decisions": this.indexHtmlCache,
					"/decisions/*": this.indexHtmlCache,
					"/statistics": this.indexHtmlCache,
					"/settings": this.indexHtmlCache,
