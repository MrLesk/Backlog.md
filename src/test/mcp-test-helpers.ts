...
/**
 * Creates MCP configuration for a test environment
 */
export function setupMcpConfiguration(testDir: string, mode: "development" | "global"): void {
	let config: object;
	...
	writeFileSync(resolve(testDir, ".mcp.json"), JSON.stringify(config, null, 2));
}
