						...
						<>
							{!showConfirmation ? (
									...
									<button
										...
										disabled={isExecuting}
										className="rounded-md border border-red-600 px-4 py-2 text-sm font-medium text-red-600 transition-colors duration-200 hover:bg-red-600/10 disabled:opacity-50 dark:border-red-400 dark:text-red-400 dark:hover:bg-red-400/10"
									>
