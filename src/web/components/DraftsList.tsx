    ...
    <div className="flex-1 bg-white">
      <div className="p-6">
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-2xl font-bold text-gray-900">Draft Tasks</h1>
        ...
        {drafts.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="mt-1 text-sm text-gray-500">Draft tasks will appear here before they're promoted to the main backlog.</p>
          </div>
        ) : (
